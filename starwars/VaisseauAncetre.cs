...
internal abstract class VaisseauAncetre : Object
{
    ...
    // constructeur
    public VaisseauAncetre(string pilote)
    {
        this.pilote = pilote;
    }

    public VaisseauAncetre(string pilote, int nbMisille)
    {
        this.pilote = pilote;
        this.Add(nbMisille);
    }
    ...
    public abstract void AfficheNom();
}
